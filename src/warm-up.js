...
var sequel = `${title} and the Goblet of Fire`
...
if (pages < 1000) {
  ...
  console.log('Ok, maybe I could read that in day and a half');
}
...
if (isFavorite = true) {
  console.log(`My favorite book it ${title}!`);
} else {
...
var books = ['The Hunger Games', 'Mockingjay', 'Catching Fire', 'Maze Runner', 'The Scorch Trials']
...
var belowTwoHundred = [12, 20, 39, 150, 199, 35, 44, 98, 138, 192, 177, 43]
